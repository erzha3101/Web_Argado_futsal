...
if ($is_logged_in) {
  ...
  // Set profil ke null untuk pengguna yang belum login
  $profil = null;
}
...
<body>
  ...
  <section class="jumbotron" id="home">
    <main class="contain" data-aos="fade-right" data-aos-duration="1000">
      <h1 class="text-light">Sehatkan Dirimu Dengan Berolahraga di <span>Argado</span> Futsal </h1>
  ...
  <section class="about" id="about">
    ...
    <div class="row">
      <div class="about-img" data-aos="fade-right" data-aos-duration="1000">
        <img src="img/argado1.jpeg" alt="" />
      </div>
      <div class="contain" data-aos="fade-left" data-aos-duration="1000">
        <h4 class="text-center mb-3">Kenapa Memilih kami?</h4>
        <p>Di Argado Futsal, kami tidak hanya menawarkan lapangan futsal yang berkualitas, tetapi juga pengalaman bermain yang menyenangkan dan penuh semangat. Terletak di Cipayung, Jakarta Timur. fasilitas kami dirancang untuk menjadi destinasi utama bagi para penggemar futsal dari berbagai usia dan tingkat keterampilan.permainan, jaring, dan peralatan yang dibutuhkan untuk menjalankan aktivitas olahraga dengan lancar.</p>
      </div>
    </div>
  </section>
  <!-- End About -->
  ...
  <section class="pembayaran" id="bayar">
    <h2 data-aos="fade-down" data-aos-duration="1000">
      <span>Prosedur</span> <span>Pemesanan Lapangan</span>
    </h2>
    <p class="text-center">Berikut adalah tata cara pemesanan lapangan pada website Argado Futsal:</p>
    <ul class="border list-group list-group-flush mt-5">
      <li class="list-group-item">1. Pengguna harus membuat akun atau mendaftar sebagai anggota pada website Argado Futsal.</li>
      ...
      <li class="list-group-item">8. Setelah status sudah di setujui, silahkan datang ke Argado Futsal sesuai jadwal yang di pesan</li>
    </ul>
  </section>
  <!-- End Pembayaran -->
  ...
  <section id="contact" class="contact" data-aos="fade-down" data-aos-duration="1000">
    ...
    <div class="row">
      <div class="col">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15862.294842492332!2d106.8889016!3d-6.319589!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ed3fe4fc48af%3A0x5afc225092e10776!2sArgado%20FC!5e0!3m2!1sen!2sid!4v1724763182946!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="maps"></iframe>
      </div>
      <div class="col">
        <form action="send_message.php" method="post">
          ...
          <div class="input-group">
            ...
            <input type="text" name="message" placeholder="Pesan" class="form-control" required />
          </div>
  ...
  <footer>
    ...
    <div class="links">
      ...
      <?php if (isset($_SESSION['id_user'])): ?>
        <!-- Jika user sudah login, tampilkan link Lapangan dan Pembayaran -->

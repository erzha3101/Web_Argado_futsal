  ...
  <section class="lapangan" id="lapangan">
    <div class="container">
      <main class="contain" data-aos="fade-right" data-aos-duration="1000">
        <h2 class="text-head">Lapangan <span>Argado</span> Futsal </h2>
          ...
          <?php foreach ($lapangan as $row) : ?>
            <div class="col">
              <div class="card">
                ...
                <div class="card-body text-center">
                  ...
                  <!-- Tombol Pesan pada lapangan.php -->
                  <a href="#" data-bs-toggle="modal" data-bs-target="#pesanModal<?= $row["212279_id_lapangan"]; ?>" class="btn btn-inti">Pesan</a>
                </div>
              </div>
            </div>
            ...
            <div class="modal fade" id="pesanModal<?= $row["212279_id_lapangan"]; ?>" tabindex="-1" aria-labelledby="pesanModalLabel<?= $row["212279_id_lapangan"]; ?>" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="pesanModalLabel<?= $row["212279_id_lapangan"]; ?>">Pesan <?= $row["212279_nama"]; ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <form action="" method="post">
                    <div class="modal-body">
                      ...
                      <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="numberic" name="jam_mulai" class="form-control" id="exampleInputPassword1"required>
                          </div>
                        </div>
                      </div>
                    </div>
